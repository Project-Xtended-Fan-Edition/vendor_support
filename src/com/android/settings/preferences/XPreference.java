...
public class XPreference extends Preference {
    ...
    public XPreference(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        switch (position) {
            case 0: // Top
                setLayoutResource(R.layout.x_preference_top);
                break;
            case 1: // Middle
                setLayoutResource(R.layout.x_preference_middle);
                break;
            case 2: // Bottom
                setLayoutResource(R.layout.x_preference_bottom);
                break;
            case 3: // Full
